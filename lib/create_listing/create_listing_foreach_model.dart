...
//
//     final createListForEach = createListForEachFromJson(jsonString);

import 'dart:convert';

CreateListForEach createListForEachFromJson(String str) => CreateListForEach.fromJson(json.decode(str));

String createListForEachToJson(CreateListForEach data) => json.encode(data.toJson());

class CreateListForEach {
  CreateListForEach({
    this.status,
    this.cities,
    this.states,
  ...
  factory CreateListForEach.fromJson(Map<String, dynamic> json) => CreateListForEach(
