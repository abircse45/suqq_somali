...
class _CarFilterScreenState extends State<CarFilterScreen> {
  ...
  final selectedmodelYear = TextEditingController();
      ...
      bottomNavigationBar:          Padding(
        ...
        child: Container(
          ...
          child: ElevatedButton(
            onPressed: () {
              final modelYrearData = selectedmodelYear.text;
              final maxxxx = max.text;
              final minnnnn = min.text;
              final milageee = milage.text;
              carSaerchController.carGetSaerchDataCalling(
                currentSelectedByaCar,
                selectedCarBrand,
                selectedValueArea,
                modelYrearData,
                selectedColor,
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              items: carController.carBrandList.map((element) {
                    ...
                    return Padding(
                      ...
                      child: Container(
                        ...
                        child: SearchableDropdown(
                          ...
                          items: carController.getCar.value.cities.map((e) {
                            return DropdownMenuItem(
                              child: Text(
                                "${e.cityName},${e.state}",
                                style: TextStyle(fontSize: 15),
                              ),
                              value: "${e.cityName},${e.state}",
                            );
                          }).toList(),
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              items: carController.carColorList.map((element) {
                                print("object : $element");
                                return DropdownMenuItem(
                                  value: element,
                                  child: Padding(
                        ...
                        child: Container(
                          ...
                          child: DropdownButtonHideUnderline(
                            child: DropdownButton(
                              ...
                              items:
                                  carController.transmissionList.map((element) {
                                print("object : $element");
                                return DropdownMenuItem(
                                  value: element,
                                  child: Padding(
