...
import 'package:suuq_somali/property/search_screen.dart';
      ...
      bottomNavigationBar:      Padding(
        ...
        child: Container(
          ...
          child: ElevatedButton(
            ...
            style: ButtonStyle(
              backgroundColor:
              MaterialStateProperty.all<Color>(HexColor("#dc3545"),),
            ),
        ...
        child: Column(
          children: [
            ...
            Obx(
                ...
                return Padding(
                  padding:
                  const EdgeInsets.only(left: 15.0, right: 27.0, top: 8),
                  child: Container(
                    height: 65,
            ...
            Obx(
                ...
                return Padding(
                  padding:
                  const EdgeInsets.only(top: 10.0, left: 15, right: 25),
                  child: Container(
                    height: 65,
                    decoration: BoxDecoration(
                      color: Colors.white,
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    print(
                                        "Property....${currentSelectedValueProperty}");
                                  });
                                },
                                child: Container(
                              ...
                              return InkWell(
                                onTap: () {
                                  setState(() {
                                    ...
                                    print(
                                        "BathRooms ${currentSelectedValueBathroom}");
                                  });
                                },
                                child: Padding(
                                  padding: const EdgeInsets.only(
